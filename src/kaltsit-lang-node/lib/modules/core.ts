 ...
 */
export const validate = (statements: string[]) => {
 ...
 */
export const condition = (statement: string, pointer: number, variables: any) => {
 ...
 */
export const goto = (statement: string, pointer: number) => {
 ...
 */
export const returns = (statement: string, pointer: number, variables: any) => {
 ...
 */
export const calculate = (statement: string, pointer: number, currentCalc: number, variables: any) => {
  ...
  const operands = control[0].split(" ").map((operand: string) => variables.get(calculateNumber(operand)));
  const variableIndex = calculateNumber(control[1]);

  if (otherStringIncludes || operands.length < 1) throw throwError(pointer, "SYNTAX_ERROR_ARITHMETIC");
 ...
 */
export const substitute = (statement: string, pointer: number) => {
 ...
 */
export const printout = (statement: string, pointer: number, variables: any) => {
